...
class FakeFilesRepository : FilesRepository {
    ...
    override suspend fun getFolderContents(folderId: String?): FolderContents = when (folderId) {
    ...
    private companion object {
        ...
        val PROF_ABYLKHOZHIN   = FilesFolder("prof_abylkhozhin",    "Abylkhozhin Zhulduzbek Bekmuhamedovich")
        val PROF_CHALOVA       = FilesFolder("prof_chalova",        "Chalova Aida")
        val PROF_KOBZHANOVA    = FilesFolder("prof_kobzhanova",     "Kobzhanova Ainura")
        val PROF_MOLDAGALIYEVA = FilesFolder("prof_moldagaliyeva",  "Moldagaliyeva Aizhan")
        val PROF_OSPANOV       = FilesFolder("prof_ospanov",        "Ospanov Tauyekel")
        val PROF_RYSKILDINOVA  = FilesFolder("prof_ryskildinova",   "Ryskildinova Dinara")
    }
}