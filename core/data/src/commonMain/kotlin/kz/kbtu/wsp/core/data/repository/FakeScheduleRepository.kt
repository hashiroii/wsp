...
class FakeScheduleRepository : ScheduleRepository {
    ...
    override suspend fun getClassEntries(): List<ClassEntry> = MOCK_CLASS_ENTRIES

    override suspend fun getExamEntries(): List<ExamEntry> = MOCK_EXAM_ENTRIES

    private companion object {
        val MOCK_CLASS_ENTRIES: List<ClassEntry> = listOf(
        ...
        val MOCK_EXAM_ENTRIES: List<ExamEntry> = listOf(
