...
class FakeNewsRepository : NewsRepository {
    ...
    override suspend fun getAllNews(): List<NewsItem> = MOCK_ALL_NEWS

    override suspend fun getComments(newsId: String): List<NewsComment> = MOCK_COMMENTS[newsId] ?: emptyList()

    private companion object {
        val MOCK_ALL_NEWS: List<NewsItem> = listOf(
            NewsItem(
        ...
        val MOCK_COMMENTS: Map<String, List<NewsComment>> = mapOf(
            "n1" to listOf(
