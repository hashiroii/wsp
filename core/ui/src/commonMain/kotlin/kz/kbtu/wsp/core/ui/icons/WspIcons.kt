...
object WspIcons {
    ...
    val Email: ImageVector by lazy {
        ImageVector.Builder("Email", 24.dp, 24.dp, 24f, 24f)
            .addPath(
                addPathNodes("M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"),
                fill = SolidColor(Color(0xFF000000))
            ).build()
    }
    ...
    val Phone: ImageVector by lazy {
        ImageVector.Builder("Phone", 24.dp, 24.dp, 24f, 24f)
            .addPath(
                addPathNodes("M6.62 10.79c1.44 2.83 3.76 5.14 6.59 6.59l2.2-2.2c.27-.27.67-.36 1.02-.24 1.12.37 2.33.57 3.57.57.55 0 1 .45 1 1V20c0 .55-.45 1-1 1-9.39 0-17-7.61-17-17 0-.55.45-1 1-1h3.5c.55 0 1 .45 1 1 0 1.25.2 2.45.57 3.57.11.35.03.74-.25 1.02l-2.2 2.2z"),
                fill = SolidColor(Color(0xFF000000))
            ).build()
    }
    ...
    val CalendarToday: ImageVector by lazy {
        ImageVector.Builder("CalendarToday", 24.dp, 24.dp, 24f, 24f)
            .addPath(
                addPathNodes("M20 3h-1V1h-2v2H7V1H5v2H4c-1.1 0-2 .9-2 2v16c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 18H4V8h16v13z"),
                fill = SolidColor(Color(0xFF000000))
            ).build()
    }

    val Ring: ImageVector by lazy {
        ImageVector.Builder("Ring", 24.dp, 24.dp, 24f, 24f)
            .addPath(
                addPathNodes("M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm0-12c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4z"),
                fill = SolidColor(Color(0xFF000000))
            ).build()
    }
}